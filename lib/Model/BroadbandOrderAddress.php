...
class BroadbandOrderAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['house_name'] === null) {
            $invalidProperties[] = "'house_name' can't be null";
        }
        if ((mb_strlen($this->container['house_name']) < 1)) {
            $invalidProperties[] = "invalid value for 'house_name', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setHouseName($house_name)
    {
        if (is_null($house_name)) {
            throw new \InvalidArgumentException('non-nullable house_name cannot be null');
        }

        if ((mb_strlen($house_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $house_name when calling BroadbandOrderAddress., must be bigger than or equal to 1.');
        }
